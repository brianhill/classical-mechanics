...
* Presentations for Monday:
  * Grace: [This is a slo-mo video](./resources/GraceOnSwing.mp4) of you on a swing &mdash; Use some equally-spaced frames in the video to measure some successive angles, and from the angles, you can make an accurate motion and thereby reasonably-accurately deduce the acceleration vectors at any point in the arc (such as the top of the arc, the bottom of the arc, and part-way in-between &mdash; For definitess and agreement with Sasha's presentation, let's say part-way is when you were 60&deg; from vertical
